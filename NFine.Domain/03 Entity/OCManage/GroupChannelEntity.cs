...
{
   public class GroupChannelEntity : IEntity<GroupChannelEntity>, ICreationAudited, IDeleteAudited, IModificationAudited
    {
       public string F_Id { get; set; }
        ...
        /// <summary>
        /// Desc:行业类型（1=行业；2=短信；3=验证码）
        /// Default:- 
        /// Nullable:True 
        /// </summary>
        public string F_TradeType { get; set; }
    }
}
