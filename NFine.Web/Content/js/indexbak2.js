...
//                        _html += '<li>';
//                        _html += '<a data-id="' + subrow.F_Id + '" href="#" class="dropdown-toggle"><i class="' + subrow.F_Icon + '"></i><span>' + subrow.F_FullName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
//                        //_html += '<li class="common"><a  class="menuItem"  data-id="' + subrow.F_Id + '" href="' + subrow.F_UrlAddress + '" data-index="' + subrow.F_SortCode + '"><i class="' + subrow.F_Icon + '"></i><span>' + subrow.F_FullName + '</span></a></li>';
