...
namespace NFine.Code
{
    public class FileHelper
    {
        ...
        /// </summary>
        /// <param name="filePath">文件的绝对路径</param>
        /// <param name="allowExtensionList">允许的文件类型</param>
        /// <returns></returns>
        public static bool CheckExtension(string filePath, string[] allowExtensionList)
        {
            string fileExtenstion = GetExtension(filePath);
            foreach (string extension in allowExtensionList)
            {
                if (extension.ToLower() == fileExtenstion.ToLower())
                    return true;
            }
            return false;
        }
